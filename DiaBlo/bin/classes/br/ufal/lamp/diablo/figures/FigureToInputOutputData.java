...
public class FigureToInputOutputData extends RectangleFigure {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2961342531701682657L;

	public FigureToInputOutputData() {
		super(new Point(0,0), new Point(0,0));
	}

	public FigureToInputOutputData(Point origin, Point corner) {
		super(origin,corner);
	}
