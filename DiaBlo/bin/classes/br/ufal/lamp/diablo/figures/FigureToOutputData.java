...
public class FigureToOutputData extends RectangleFigure {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6580018853150692072L;

	public FigureToOutputData() {
		super(new Point(0,0), new Point(0,0));
	}

	public FigureToOutputData(Point origin, Point corner) {
		super(origin,corner);
	}
